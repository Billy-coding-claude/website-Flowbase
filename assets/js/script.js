...
(function () {
  ...
  var I18N = {
    en: {
      ...
      'hero.eyebrow': 'Web design studio · Based in the Netherlands',
      'hero.lead': 'We build',
      'hero.rotateAll': 'websites, apps, branding, and growth.',
      'hero.sub': 'Flowbase builds clean, fast, conversion-focused websites, apps and branding for local businesses. Premium quality, without the €5,000 agency price tag.',
      ...
      'services.lead': 'Four focused services — website, app, branding, or AI assistant. Mix and match, or take a bundle.',
      'svc1.title': 'Websites',
      ...
      'svc2.title': 'Branding',
      'svc2.body': 'A professional visual identity — logo, colors, and typography — so your business looks the part everywhere it shows up.',
      'svc2.t1': 'Logo design, PNG and SVG files',
      'svc2.t2': 'Color palette & typography',
      'svc2.t3': 'Social profile assets included',
      'svc3.title': 'AI Assistant',
      'svc3.body': 'Your own AI assistant, connected to your business via Telegram or WhatsApp. Answers questions, runs automations, and keeps you updated.',
      'svc3.t1': 'Telegram / WhatsApp connection',
      'svc3.t2': '2 custom automations included',
      'svc3.t3': 'Persistent memory & daily summaries',
      ...
      'meta.desc.home': 'Flowbase builds websites, apps, branding and AI assistants for local businesses in the Netherlands. Clean, fast, conversion-focused — without the agency price tag.',
      'meta.desc.services': 'Websites, apps, branding and AI assistant for local businesses in the Netherlands — clear benefits, done for you by one studio.',
      ...
      'pr.bun.lead': 'Website, branding and AI — with 3 months free care. Better together, priced to match.',
      'pr.bun.was': 'Normally',
      ...
      'pr.bun.cmp.b2price': 'from €2,195',
      'pr.bun.cmp.b3price': 'from €3,595',
      ...
      'pr.bun2.name': 'Growth',
      'pr.bun2.tag': 'Serious growth with branding & AI.',
    ...
    nl: {
      ...
      'hero.eyebrow': 'Webdesign studio · Gevestigd in Nederland',
      'hero.lead': 'Wij maken',
      'hero.rotateAll': 'websites, apps, branding en groei.',
      'hero.sub': 'Flowbase bouwt strakke, snelle websites, apps en branding voor lokale ondernemers. Premium kwaliteit, zonder het prijskaartje van €5.000 van een bureau.',
      ...
      'services.lead': 'Vier heldere diensten — website, app, branding of AI-assistent. Los of als bundel.',
      'svc1.title': 'Websites',
      ...
      'svc2.title': 'Branding',
      'svc2.body': 'Een professionele visuele identiteit — logo, kleuren en typografie — zodat je bedrijf er overal goed uitziet.',
      'svc2.t1': 'Logo-ontwerp, PNG- en SVG-bestanden',
      'svc2.t2': 'Kleurenpalet & typografie',
      'svc2.t3': 'Social profile assets inbegrepen',
      'svc3.title': 'AI Assistant',
      'svc3.body': 'Je eigen AI-assistent, verbonden met je bedrijf via Telegram of WhatsApp. Beantwoordt vragen, voert automatiseringen uit en houdt je op de hoogte.',
      'svc3.t1': 'Telegram / WhatsApp-koppeling',
      'svc3.t2': '2 maatwerk-automatiseringen inbegrepen',
      'svc3.t3': 'Persistent geheugen & dagelijkse samenvattingen',
      ...
      'meta.title.contact': 'Contact — Flowbase',
      'meta.desc.home': 'Flowbase bouwt websites, apps, branding en AI-assistenten voor lokale ondernemers in Nederland. Snel, strak en resultaatgericht — zonder het bureautarief.',
      'meta.desc.services': 'Websites, apps, branding en AI-assistent voor lokale ondernemers in Nederland — heldere voordelen, voor je gedaan door één studio.',
      ...
      'pr.bun.lead': 'Website, branding en AI — met 3 maanden gratis onderhoud. Samen sterker, voordeliger geprijsd.',
      'pr.bun.was': 'Normaal',
      ...
      'pr.bun.cmp.b2price': 'vanaf €2.195',
      'pr.bun.cmp.b3price': 'vanaf €3.595',
      'pr.bun1.name': 'Starter',
      ...
      'pr.bun2.name': 'Growth',
      'pr.bun2.tag': 'Serieuze groei met branding én AI.',
  ...
  var ROTATE = {
    en: ['Websites', 'Apps', 'Branding', 'Growth'],
    nl: ['Websites', 'Apps', 'Branding', 'Groei']
  };
